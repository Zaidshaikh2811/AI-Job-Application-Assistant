...
const ResumeTemplateClassic = ({ data }: { data: ResumeData }) => (
    <div className="bg-white mx-auto p-4 mt-20">


        <div className="max-w-5xl mx-auto my-6 font-sans text-gray-800 border border-gray-300  " style={{ fontSize: '11pt' }}>
            {/* Header Section */}
